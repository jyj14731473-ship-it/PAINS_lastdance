...
from lib.modeling import NumpyRidgeRegressor, clip_predictions, get_git_commit, make_design_matrices
...
def run(config: dict, train_df, test_df) -> dict:
    ...
    if not feature_columns:
        raise ValueError("baseline_collected_xgboost has no available features.")
    ...
    return {
        "model_name": "baseline_collected_xgboost",
        "config": cfg,
        "metrics": metrics,
